...
# ======================================================================================================================
# 분할 매수 시간 설정
BACKTEST_BUY_TIME_1 = "09:05"
BACKTEST_BUY_TIME_2 = "10:40"

# 기간 만료 매도 시간
SELL_TIME_FOR_EXPIRATION = "15:10"



# 수익률이 이 값 이상일 때 매도
SELLING_POINT_UPPER = 1.04
...
# 백테스트에서 제외할 종목 Ticker 리스트
# 여기에 제외하고 싶은 종목의 코드를 문자열 형태로 추가하세요.
EXCLUDED_STOCKS = [
    # "005930",  # 예시: 삼성전자
]
